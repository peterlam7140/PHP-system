                    ...
                    <div class="container-fluid px-0">
                        <span class="navbar-brand mb-0">
                            <div class="header-logo">
                                ...
                                <div class="fs-4 text-white"><?= WEBSITE_NAME ?> <span class="badge text-bg-success">(Student)</span></div>
                            </div>
                        </span>
                ...
                <div class="offcanvas-body">
                    <div class="card shadow-sm">
                        <ul class="list-group list-group-flush">
                            <a class="list-group-item list-group-item-action" href="./welcome.php"><div class="menu-icon"><i class="fa-solid fa-house"></i> Timetable</div></a>
                            ...
                            <a class="list-group-item list-group-item-action" href="./transcript_dashboard.php"><div class="menu-icon"><i class="fa-solid fa-chart-line"></i> Academic Statistic</div></a>
                            <a class="list-group-item list-group-item-action" href="./transcript_export.php" target="_blank"><div class="menu-icon"><i class="fa-solid fa-scroll"></i> Transcript</div></a>
                ...
                <div class="sidebar-menu">
                    <div class="card shadow-sm">
                        <ul class="list-group list-group-flush">
                            ...
                            <a class="list-group-item list-group-item-action" href="./change_password_form.php"><div class="menu-icon"><i class="fa-solid fa-key"></i> Change Password</div></a>
                            <a class="list-group-item list-group-item-action" href="./course_list.php"><div class="menu-icon"><i class="fa-solid fa-book"></i> Course</div></a>
                            <a class="list-group-item list-group-item-action" href="./transcript_dashboard.php"><div class="menu-icon"><i class="fa-solid fa-chart-simple"></i> Academic Statistic</div></a>
                            <a class="list-group-item list-group-item-action" href="./transcript_export.php" target="_blank"><div class="menu-icon"><i class="fa-solid fa-scroll"></i> Transcript</div></a>
                            <a class="list-group-item list-group-item-action bg-danger text-white" href="./logout.php"><div class="menu-icon"><i class="fa-solid fa-arrow-right-from-bracket"></i> Logout</div></a>
                        </ul>
                    </div>
